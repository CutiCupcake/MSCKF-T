...
bool ImageProcessor::loadParameters() {
  ...
  cv::Mat     T_imu_cam0 = utils::getTransformCV(nh, "cam0/T_cam_imu");//赋予外参
  ...
  nh.param<int>("grid_row", processor_config.grid_row, 4);//网格分类  4
...
bool ImageProcessor::createRosIO() {
  ...
  cam0_img_sub.subscribe(nh, "cam0_image", 10);//监听图片
...
void ImageProcessor::initializeFirstFrame() {
  ...
  static int grid_height = img.rows / processor_config.grid_row;//每个网格的大小
